...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            File myFile = new File("C:\\Users\\Alex\\Dropbox\\JavaRush_VK\\tmp.txt");
            ...
            loadedObject.string2.print();//check here that the object variable equals to loadedObject - проверьте тут, что object и loadedObject равны
