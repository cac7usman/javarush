...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("sav", ".txt", new File("C:\\Users\\asus\\Dropbox\\JavaRush_VK\\"));
            ...
            user1.setLastName("Volkov");
            user1.setBirthDate(dateFormat.parse("25.01.1990"));
            user1.setMale(true);
    ...
    public static class JavaRush {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            user.setFirstName(name);    //implement this method - реализуйте этот метод
